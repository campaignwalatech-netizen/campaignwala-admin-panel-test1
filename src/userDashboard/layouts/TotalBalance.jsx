...
const TotalBalance = ({ darkMode }) => {
  ...
  return (
    <main
      className={`min-h-screen pt-24 pb-32 px-4 sm:px-6 md:px-10 transition-all duration-300 ${
    ...
    >
      ...
      {/* Total Earnings Card */}
      <section
        className={`rounded-lg border mb-8 p-6 text-center md:text-left ${
      ...
      {/* Important Note */}
      <section
        className={`rounded-lg border mb-8 p-5 text-sm ${
          darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"
        }`}
      >
