...
const ApprovedLeads = ({ darkMode }) => {
  ...
  // 🔍 Filter logic (same as Pending Leads)
                ...
                {filteredLeads.length > 0 ? (
                  filteredLeads.map((lead) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">{lead.approvedDate}</td>
                      <td className="py-3 px-4">{lead.commission}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
            ...
            {filteredLeads.length > 0 ? (
              filteredLeads.map((lead) => (
                ...
                >
                  ...
                  <p className="text-sm">
                    <strong>Approved:</strong> {lead.approvedDate}
                  </p>
                </div>
              ))
            ) : (
