  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      status: "sent",
      message: "Please complete your profile to unlock all features and get personalized recommendations.",
    },
    {
      id: "2",
      ...
      sentDate: "1 day ago",
      status: "sent",
      message: "Limited time offer! Get 50% off on all products. Use code SUMMER50 at checkout.",
    },
    {
      id: "3",
      ...
      sentDate: "3 days ago",
      status: "sent",
      message: "We are excited to announce our new AI-powered recommendation engine.",
    },
    {
      id: "4",
      ...
      sentDate: "5 days ago",
      status: "sent",
      message: "Exclusive flash sale for our premium members. 48 hours only!",
    },
    {
      id: "5",
